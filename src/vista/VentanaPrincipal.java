...
/**
 * Hay uqe recordar q este codigo tiene partes que son autogeneradas, por el 
 * propio gestor swing, lo que significa que cualquier modificacion dentro de 
 * este codigo que dice Generated Code, sera recuperado y puesot como 
 * originalmente estaba, y cualquier cambio que hagamos se eliminará.
 */
...
/** De aqui en adelante se genera codigo automaticamente, y cualquier cambio
 * que de haga, será eliminado y recupera el codigio original que hubiera hecho
 * el grestor de vistas Swing del netbeans previamente. Lo mejor es no tocarlo
*/                            
  /** En este caos se ha tocado una sola linea y es la primera de todo el codigo
   * despues de la llave { que inicia el metodo.
   * 
   * La linea es // entityManager = java.beans que se modifico desde afuera con
   * un getor de texto como gedit
   */
...
//        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory(null).createEntityManager();
        ...
        setTitle("Lista de Registros en la Base de Datos");
